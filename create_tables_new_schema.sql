...
---CREATE TABLE tweets_copy AS
---SELECT * FROM sentiment_tweet;
...
COPY sentiment_tweet (
    ...
    user_name,
    sentiment)
FROM 'c:/postgresql/scripts/sentimentTweets20181129.csv'
WITH DELIMITER ',';
...
COPY sentiment_tweet (
    ...
    user_name,
    sentiment)
FROM 'c:/postgresql/scripts/sentimentTweets20181130.csv'
WITH DELIMITER ',';
...
COPY sentiment_tweet (
    ...
    user_name,
    sentiment)
FROM 'c:/postgresql/scripts/sentimentTweets20181201.csv'
WITH DELIMITER ',';
...
COPY sentiment_tweet (
    ...
    user_name,
    sentiment)
FROM 'c:/postgresql/scripts/sentimentTweets20181202.csv'
WITH DELIMITER ',';
...
COPY sentiment_tweet (
    ...
    user_name,
    sentiment)
FROM 'c:/postgresql/scripts/sentimentTweets20181203.csv'
WITH DELIMITER ',';
